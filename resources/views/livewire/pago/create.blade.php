        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" wire:model="nombre" class="form-control" id="nombre" style="background-color: transparent;" readonly>
                    @error('nombre')
                ...
                <div class="form-group">
                    ...
                    <textarea wire:model="descripcion" class="form-control" id="descripcion" rows="9" style="background-color: transparent;" readonly></textarea>
                    @error('descripcion')
                        <span class="error text-danger">* {{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" wire:model="monto" class="form-control" placeholder="0.00" min="0" style="background-color: transparent;" readonly>
