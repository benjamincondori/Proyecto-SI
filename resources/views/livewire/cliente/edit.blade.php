    ...
    <form class="px-4 pt-2 pb-2">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <div class="custom-file">
                            <input type="file" wire:model="registroSeleccionado.imagen" class="custom-file-input" id="field-10">
                            <label class="custom-file-label">Elija una foto</label>
                        </div>
                    </div>
                    @error('registroSeleccionado.imagen')
                        <span class="error text-danger">* {{ $message }}</span>
                    @enderror
                </div>
            </div>
        ...
        <div class="form-group text-right m-b-0">
            <div class="form-group text-right m-b-0">
                ...
                <button class="btn btn-primary waves-effect waves-light" wire:click="actualizarCliente"
