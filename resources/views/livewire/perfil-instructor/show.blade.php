        ...
        <div class="col-lg-3 col-xl-3">
            <div class="card-box">
                <div class="row justify-content-center">
                    <img src="{{ asset('assets/images/users/user-5.jpg') }}" class="rounded-circle avatar-lg img-thumbnail" style="width: 120px; height: 120px;" alt="profile-image">
                </div>
                ...
                <div class="row">
                    <ul class="nav nav-pills navtab-bg w-100 px-2 py-1">
                        ...
                        <li class="nav-item w-100 mt-1">
                            <a href="#grupos" wire:click="changeTabs('grupos', 'Grupos')" 
                            data-toggle="tab" aria-expanded="true" class="nav-link {{ $activeTab === 'grupos' ? 'active' : '' }}">
                                <i class="fas fa-book mr-2"></i>Grupos
                            </a>
                        </li>
                        <li class="nav-item w-100 mt-1">
                            <a href="#alumnos" wire:click="changeTabs('alumnos', 'Alumnos')" 
                            data-toggle="tab" aria-expanded="true" class="nav-link {{ $activeTab === 'alumnos' ? 'active' : '' }}">
                                <i class="fas fa-user-friends mr-2"></i>Alumnos
                            </a>
                        </li>
                        {{-- <li class="nav-item w-100 mt-1">
        ...
        <div class="col-lg-9 col-xl-9">
            <div class="card-box">
                <div class="tab-content p-0">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label">ID del Instructor :</label>
                                        <input wire:model="id_instructor" class="form-control" 
                                        @if (!$editar)
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $especialidad }}" class="form-control" 
                                        @if (!$editar)
                                            style="background: transparent"
                                        @endif
                                        readonly>
                    ...
                    <div class="tab-pane {{ $activeTab === 'grupos' ? 'active' : '' }}" id="grupos">
                        <h5 class="mb-3 text-uppercase text-white bg-dark p-2 rounded-lg"><i class="fas fa-book mr-1"></i> Grupos </h5>
                                ...
                                <table class="table table-hover mb-0">
                                    <thead class="bg-dark text-white text-center text-nowrap">
                                        <tr style="cursor: pointer">
                                            ...
                                            <th scope="col">Nro de Integrantes</th>
                                            ...
                                            @foreach ($grupos as $grupo)
                                                <tr class="text-nowrap text-center">
                                                    ...
                                                    <td class="align-middle">
                                                        {{ $grupo->nombre }}</td>
                                                    <td class="align-middle">
                                                        {{ $grupo->disciplina->nombre }}</td>
                                                    <td class="align-middle">
                                                        {{ $grupo->nro_integrantes }}</td>
                                                    <td class="align-middle">
                                                        {{ $grupo->horario->descripcion }}</td>
                                                    <td class="align-middle">
                                                        {{ $this->formatoHora($grupo->horario->hora_inicio) }}</td>
                                                    <td class="align-middle">
                                                        {{ $this->formatoHora($grupo->horario->hora_fin) }}</td>
                                                </tr>
                                            @endforeach
                                        @else
                    ...
                    <div class="tab-pane {{ $activeTab === 'alumnos' ? 'active' : '' }}" id="alquiler">
                        <h5 class="mb-3 text-uppercase text-white bg-dark p-2 rounded-lg"><i class="fas fa-user-friends mr-1"></i> Alumnos </h5>
                                    ...
                                    <tbody>
                                        @if ($alumnos->count())
                                            @foreach ($alumnos as $alumno)
                                                <tr class="text-nowrap text-center">
                                                    <th scope="row" class="align-middle">{{ $alumno->id }}</th>
                                                    <td class="align-middle">
                                                        {{ $alumno->nombres }}</td>
                                                    <td class="align-middle">
                                                        {{ $alumno->apellidos }}</td>
                                                    <td class="align-middle">
                                                        {{ $alumno->telefono }}</td>
                                                    <td class="align-middle">
                                                        {{ ($alumno->genero == 'M') ? 'Masculino' : 'Femenino' }}</td>
                                                </tr>
                                            @endforeach
                                        @else
                                            <tr class="text-center">
