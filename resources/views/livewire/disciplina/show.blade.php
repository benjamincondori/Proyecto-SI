    ...
    @else
                ...
                <tbody>
                    ...
                    @else
                        <tr class="text-center">
                            <td colspan="6">No existe ningún registro.</td>
                        </tr>
                    @endif
                </tbody>
            </table>
        ...
        <div class="d-flex justify-content-end justify-content-sm-between pt-3 pb-0">
            <div class="text-muted d-none d-sm-block pt-1">
                Mostrando del {{ ($disciplinas->firstItem()) ? $disciplinas->firstItem() : 0 }} al {{ ($disciplinas->lastItem()) ? $disciplinas->lastItem() : 0 }} de {{ $disciplinas->total() }} registros
            </div>
