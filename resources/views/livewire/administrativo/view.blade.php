<div>
    ...
    <div class="form-group px-4 pt-2">
        ...
        <h3 class="fs-1 d-inline-block ml-1"><b>Datos del administrativo</b></h3>
    </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input value="{{ $id_administrativo }}" class="form-control" 
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input value="{{ $cargo }}" class="form-control" style="background: transparent" readonly>
                </div>
            </div>
        </div>
