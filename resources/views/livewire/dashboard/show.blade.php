<div>
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card-box widget-user">
                <img src="assets/images/users/user-4.jpg" class="img-responsive rounded-circle img-thumbnail" alt="user">
                <div class="mt-3">
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card-box widget-user">
                <img src="assets/images/users/user-10.jpg" class="img-responsive rounded-circle img-thumbnail" alt="user">
                <div class="mt-3">
