        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" wire:model.defer="nro_integrantes" class="form-control" id="integrantes"
                        placeholder="Ej: 20">
                    @error('nro_integrantes')
                        <span class="error text-danger">* {{ $message }}</span>
                    @enderror
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select class="form-control" wire:model.defer="id_disciplina" name="disciplina" id="disciplina">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select class="form-control" wire:model.defer="id_entrenador" name="entrenador" id="entrenador">
                        <option value="">Seleccionar</option>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select class="form-control" wire:model.defer="id_horario" name="horario" id="horario">
                        <option value="">Seleccionar</option>
