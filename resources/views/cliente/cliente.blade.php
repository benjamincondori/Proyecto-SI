            ...
            <div class="col-xl-12">
                <div class="card-box">
                    <div class="d-flex justify-content-between">
                        <h4 class="header-title mb-4">Perfil de Cliente</h4>
                                        ...
                                        <div class="col-lg-9 col-xl-9 d-flex justify-content-center" >
                                            <div class="text-center">
                                                ...
                                                <div class="text-left mt-3">
                                                    <p class="text-muted mb-2 font-13"><strong>Codigo :</strong> <span class="ml-2">{{ $cliente->id }} </span></p>

                                                    <p class="text-muted mb-2 font-13"><strong>Nombre Completo :</strong> <span class="ml-2">{{ $cliente->nombres }} {{ $cliente->apellidos }}</span></p>
            
                                                    <p class="text-muted mb-2 font-13"><strong>Telefono :</strong><span class="ml-2">{{ $cliente->telefono }}</span></p>

                                                    <p class="text-muted mb-2 font-13"><strong>Cédula de identidad :</strong><span class="ml-2">{{ $cliente->ci }}</span></p>
            
                                                    <p class="text-muted mb-2 font-13"><strong>Email :</strong> <span class="ml-2 ">{{ $cliente->email }}</span></p>
            
                                                    <p class="text-muted mb-1 font-13"><strong>Fecha de nacimiento :</strong> <span class="ml-2">{{ $cliente->fecha_nacimiento }}</span></p>
                                                </div>
