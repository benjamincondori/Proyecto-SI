...
class ReporteAsistencia extends Component
{
    ...
    public $administrativos, $clientes, $asistencias;
    ...
    public function generarReporte() {
        ...
        $this->asistencias = $query->whereBetween('fecha_de_ingreso', [$fechaDesde, $fechaHasta])->get();
    }
    ...
    public function generarPDF($id_administrativo, $id_cliente, $tipoReporte, $fechaInicio = null, $fechaFin = null) {
        ...
        $asistencias = $query->whereBetween('fecha_de_ingreso', [$fechaDesde, $fechaHasta])->get();

        $pdf = pdf::loadView('livewire.pdf.reporteAsistencia', compact('asistencias', 'tipoReporte', 'fechaInicio', 'fechaFin', 'usuario', 'cliente'));
        $pdf->setPaper('a4', 'landscape'); // Opcional: Configurar el tamaño y orientación del papel

        $descripcion = 'Se generó un reporte de Asistencias';
    ...
    {
        return view('livewire.reporte.reporte-asistencia');
    }
}
