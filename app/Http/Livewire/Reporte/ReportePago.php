...
{
    public $id_cliente, $id_administrativo, $tipoReporte, $estado, $concepto, $fechaDesde, $fechaHasta;
    public $administrativos, $clientes, $pagos;
    ...
    public function generarReporte() {
        ...
        if ($this->concepto != 0) {
            $query->where('concepto', $this->concepto);
        }
        ...
        $this->pagos = $query->whereBetween('fecha', [$fechaDesde, $fechaHasta])->get();
    }
    ...
    {
        return view('livewire.reporte.reporte-pago');
    }
}
